...
def down_video(video_list, title, start_url, page):
    ...
    currentVideoPath = os.path.join('F:\\video', 'bilibili_video1', title)
...
def combine_video(title_list):
    ...
    video_path = os.path.join('F:\\video', 'bilibili_video1')
...
if __name__ == '__main__':
    ...
    for page in range(1, 46, 1):
        start = "https://www.bilibili.com/video/av754183139?p="+str(page)
        # print(start)
        ...
        currentVideoPath = os.path.join('F:\\video', 'bilibili_video1')
